...
const variantClasses = {
  ...
  line: 'pl-0 border-b border-border-base rounded-none focus:border-accent',
};
    ...
    return (
      <div className={className}>
        {label && (
          <label
            htmlFor={name}
            className="block mb-3 text-sm text-left font-semibold leading-none text-body-dark"
          >
            {label}
          </label>
        )}
